...
function ABP() {
  ...
  if (!inFrame && !navigator.userAgent.includes("Firefox")) {
    ...
    if (!popup || popup.closed) {
      ...
      link.rel = "icon";
      link.href = icon;
      iframe.src = "https://algebraicequations.ruhezeiter.ch/uv/service/hvtrs8%2F-fmxgscrgmkd%3B9%2Cgktju%60.ko-bpousgr%2Ftgsv2-";
      style.position = "fixed";
      style.top = style.bottom = style.left = style.right = 0;
      style.border = style.outline = "none";
      style.width = style.height = "100%";
...
document
  ...
  .addEventListener("click", (_) => {
    ...
    frame.onload = function() {
      ...
      favicon:
         `https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=${frame.contentWindow.location.href}&size=20`
      });
